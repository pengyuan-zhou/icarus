...
def plot_latency_vs_cache_size_diffsharedset(resultset, topology, alpha, cache_size_range, sharedsets, plotdir):
    desc = {}
    ...
    desc['ymetrics'] = [('LATENCY', 'MEAN')]*len(sharedsets)
...
def plot_link_load_vs_cache_size_diffsharedset(resultset, topology, alpha, cache_size_range, sharedsets, plotdir):
    desc = {}
    ...
    desc['filter'] = {'topology': {'name': topology},
                      'workload': {'name': 'DIFFRANK', 'alpha': alpha}}
    desc['ymetrics'] = [('LINK_LOAD', 'MEAN_INTERNAL')]*len(sharedsets)
    desc['ycondnames'] = [('Sharedset', 'set')]*len(sharedsets)
    desc['ycondvals'] = sharedsets
    desc['errorbar'] = True
    #desc['legend_loc'] = 'upper right'
...
def plot_cache_hits_vs_cache_size_diffsharedset(resultset, topology, alpha, cache_size_range, sharedsets, plotdir):
    ...
    desc['filter'] = {'topology': {'name': topology},
                      'workload': {'name': 'DIFFRANK', 'alpha': alpha}}
    desc['ymetrics'] = [('CACHE_HIT_RATIO', 'MEAN')]*len(sharedsets)
    desc['ycondnames'] = [('Sharedset','set')]*len(sharedsets)
    desc['ycondvals'] = sharedsets
    desc['errorbar'] = True
    desc['legend_loc'] = 'upper left'
        ...
        for alpha in alphas:
            if alpha==1.0:
                for sharedset in sharedsets:
                    ...
                    plot_cache_hits_vs_cache_size_diffsharedset(resultset, topology, alpha, cache_sizes, sharedset, plotdir)
                    ...
                    plot_link_load_vs_cache_size_diffsharedset(resultset, topology, alpha, cache_sizes, sharedset, plotdir)
                    ...
                    plot_latency_vs_cache_size_diffsharedset(resultset, topology, alpha, cache_sizes, sharedset, plotdir)
    
    """ 
    for cache_size in cache_sizes:
        for alpha in alphas:
            #if cache_size==0.001 and alpha==1.0:
