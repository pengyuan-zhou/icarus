...
STRATEGY_LEGEND = {
         'LCE':             'LCE',
         'LCD':             'LCD',
         'BROKER_LCD':             'BROKER Assisted LCD',
         'HR_SYMM':         'HR Symm',
         'HR_ASYMM':        'HR Asymm',
         'HR_MULTICAST':    'HR Multicast',         
         'HR_HYBRID_AM':    'HR Hybrid AM',
         'HR_HYBRID_SM':    'HR Hybrid SM',
         'BROKER_HR_HYBRID_SM':    'BROKER Assisted HR Hybrid SM',
         'BROKER_CL4M':            'BROKER Assisted CL4M',
         'CL4M':            'CL4M',
         'BROKER_PROB_CACHE':      'BROKER Assisted ProbCache',
